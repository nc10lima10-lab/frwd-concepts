window.FRWD_CONTENT = {
  site: {
    ...
    about: {
      ...
      body:
        "FRWD Concepts is a concept portfolio by Nicole Cornehl Lima. \n\n I just graduated from the University of Michigan, having studied Computer Science in the College of Engineering (wohoo!). \n\n I'm also a serial explorer. Currently at 48 countries so far! \n\n And lastly, I’m online a lot... I just have such a love for things that feel Gen Z and relevant. ",
    },
    contact: {
  ...
  projects: [
      ...
      },
    {
      ...
      caseStudy: {
        ...
        results:
          "23K+ views and nearing 50 reposts. Built around viral content principles: immediate context, strong text overlays, relatable commentary, and timely cultural references designed to encourage shares and conversation.",
      },
    },

    {
      slug: "ugc-tiktok",
      title: "UGC TikTok",
      description: "UGC brand discovery short-form content for Meela",
      image: "assets/meela-cover.png",
      media: {
        type: "iframe",
        embed: '<iframe src="https://drive.google.com/file/d/1_227jskArV-CZnj5UIGYmBVfn6C3Rc4Q/preview" width="100%" height="600" allow="autoplay" allowfullscreen></iframe>'
      },
      categories: ["Social Media", "UGC"],
      tags: ["TikTok", "UGC", "Brand Marketing"],
      caseStudy: {
        insight:
          "Older adults want to stay independent, but technology can make everyday tasks feel harder. Meela AI solves that problem.",
        opportunity:
          "Instead of just explaining what Meela does, show how it fits naturally into the everyday moments where older adults need a little extra support.",
        hook: "I’m sorry, but I’m firing myself...",
        results:
